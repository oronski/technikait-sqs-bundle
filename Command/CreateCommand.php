...
class QueueCreateCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($this->getContainer()->has(sprintf('TechnikaIt.sqs.%s', $queueName))) {
        ...
        $io->text(sprintf('Success. New Queue URL: <comment>%s</comment>', $queueUrl));
        $io->success('Done');
    }
}
